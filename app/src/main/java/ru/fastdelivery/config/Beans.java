...
import ru.fastdelivery.usecase.TariffCalculateUseCaseImpl;
...
public class Beans {
    ...
    @Bean
    public TariffCalculateUseCase tariffCalculateUseCase(CurrencyFactory factory) {
        return new TariffCalculateUseCaseImpl(factory);
    }
}
